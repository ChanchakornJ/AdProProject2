    ...
    public void loadStage(int num) {
        switch (num) {
            ...
            case 1: // Game stage
                ...
                stage1.getGameCharacterList().get(0).setStageManager(this);
            ...
            case 2: // Game stage
                ...
                stage2.getGameCharacterList().get(0).setStageManager(this);
            ...
            case 3: // Game stage
                ...
                stage3.getGameCharacterList().get(0).setStageManager(this);
